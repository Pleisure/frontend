export default function Rating() {
  return (
    <div className="flex items-center justify-between mt-20 pb-10 rating border-b-[1px]">
      <div className="flex items-center">
        ...
        <p className="text-[42px] font-bold">4.8</p>
      </div>
      <ul className="text-[13px] rating-progress-bar">
        {RATING_COUNT_LIST.map(({ rating, value, count }) => {
          return (
            ...
            >
              <span>{rating}</span>
              <progress
                className="block w-[175px] my-[0.45rem] progress progress-info bg-grayBg"
                value={value}
                max="100"
              ></progress>
